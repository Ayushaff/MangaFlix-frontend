    ...
    return (
        ...
        <div className={styles.wrapp} style={{gap: '10px'}}>
            ...
            {true 
                ...
                <svg data-v-20f285ec="" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-icon-black dark:text-icon-white text-false icon" data-v-6b3fd699="" style={{ top: '2px' }}>
